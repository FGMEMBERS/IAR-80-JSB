...
setlistener("/sim/signals/fdm-initialized", func {
	...
	setprop("/controls/electric/external-power-volts", 0.0);
...
var update_electrical = func {
	...
	last_time = time; # This is a global variable so it persists 
...
var update_virtual_bus = func( dt ) {
	...
	var external_volts = getprop("/controls/electric/external-power-volts");
	var load = 0.0;
	...
	if ( master_bat == 1.0 ) {
	  if ( external_volts > battery_volts ) {
